Names: Andrew Engroff, Nathan Friedman
EIDs: ade466, nsf
CS IDs: aengroff, nsf
...
Results:
Creates four example trees and validates them. Three are the examples given in 
the project assignment and will report, "X tree is true" while one is an
